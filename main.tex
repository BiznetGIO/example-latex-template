...
% \authorblockA{\authorrefmark{1}Leave Affiliation List blank for your Summary (initial) submission}}
 ...
 \author{\authorblockN{Eka Tresna Irawan\authorrefmark{1} }
 \authorblockA{\authorrefmark{1}PT Biznet Gio Nusantara , Jalan Jendral Sudirman, 10220 Daerah Khusus Ibukota Jakarta, Indonesia\\ibnu@biznetgio.com}}
